...
MACRO_CONFIG_INT(ClAutoFinish, cl_autofinish, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "sh1zooo client: auto-finish bot, plans the shortest route to the finish and walks it automatically")
MACRO_CONFIG_INT(ClAutoFinishShowPath, cl_autofinish_show_path, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "sh1zooo client: render the planned route as a colored strip")
MACRO_CONFIG_INT(ClAutoFinishHook, cl_autofinish_hook, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "sh1zooo client: allow the auto-finish route to use the hook")
MACRO_CONFIG_INT(ClAutoFinishColorR, cl_autofinish_color_r, 64, 0, 255, CFGFLAG_CLIENT | CFGFLAG_SAVE, "sh1zooo client: red component of the route strip color")
MACRO_CONFIG_INT(ClAutoFinishColorG, cl_autofinish_color_g, 255, 0, 255, CFGFLAG_CLIENT | CFGFLAG_SAVE, "sh1zooo client: green component of the route strip color")
MACRO_CONFIG_INT(ClAutoFinishColorB, cl_autofinish_color_b, 170, 0, 255, CFGFLAG_CLIENT | CFGFLAG_SAVE, "sh1zooo client: blue component of the route strip color")
MACRO_CONFIG_INT(ClAutoFinishAlpha, cl_autofinish_alpha, 230, 0, 255, CFGFLAG_CLIENT | CFGFLAG_SAVE, "sh1zooo client: opacity of the route strip")
MACRO_CONFIG_INT(ClAutoFinishWidth, cl_autofinish_width, 7, 1, 20, CFGFLAG_CLIENT | CFGFLAG_SAVE, "sh1zooo client: thickness of the route strip")
MACRO_CONFIG_INT(ClAutoFinishZoom, cl_autofinish_zoom, 55, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "sh1zooo client: camera zoom level in percent while the auto-finish bot runs, 0 disables zooming")
